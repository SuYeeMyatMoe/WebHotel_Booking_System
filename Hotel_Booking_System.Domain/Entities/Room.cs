...
namespace Hotel_Booking_System.Domain.Entities
{
    public class Room
    {
        ...
        //Error Messages will be shown in span of razor form with (asp-validation-for) class (without model attribute, it will only show for null data error) While in api these will be shown as log error
